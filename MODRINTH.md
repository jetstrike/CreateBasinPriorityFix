...
In **large modpacks**, automated compacting and shapeless crafting inside Create's Mechanical Basin can quickly become a frustrating mess of recipe overlaps. 
...
**Create Basin Priority Fix** is a lightweight, out-of-the-box NeoForge addon that intercepts Create’s Basin recipe matching logic. It enforces an intelligent **4-Tier Hierarchy**, ensuring your automation works exactly as intended without complex filtering setups:

1. 🥇 **Dedicated Basin Recipes (Highest Priority):** Explicit Create mixing, heated, and automated basin recipes will **always** execute first whenever valid ingredients are present.
...
4. 4️⃣ **2x2 Packing (Lowest Priority):** Small compacting recipes requiring 4 of the same item (such as packing Sugar into Sugar Cubes), completely preventing them from hijacking ingredients intended for mixing or crafting.

---

### Features & Compatibility

- 🛠️ **Plug & Play:** Requires zero config, scripts, or datapacks. Simply drop it into your mods folder and enjoy collision-free automation!
...
- ⚙️ **Requirements:** Minecraft 1.21.1 | NeoForge | Create Mod 6.0.0+
